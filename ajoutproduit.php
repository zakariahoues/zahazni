                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="reference_p" name="reference_p" type="number" required="required" class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                        <input id="nom_p" name="nom_p" required="required" type="text" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Description</label></div>
                                    <div class="col-12 col-md-9"><textarea  id="description_p" name="description_p" rows="9" placeholder="Content..." class="form-control"></textarea></div>
                                </div>
                                <div class="form-group">
                                    <label class=" form-control-label">couleur</label>
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                        <input  id="couleur_p" type="text" name="couleur_p" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                        <input  id="quantite_p" name="quantite_p" type="number" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                        <input  id="quantite_minimale_p" type="number" name="quantite_minimale_p" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="prix_p" name="prix_p" required="required" type="number" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div  class="input-group-addon"><i class="fa fa-usd"></i></div>
                                        <input id="prix_de_vente_p" name="prix_de_vente_p" type="number" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted"> </small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="date_p" name="date_p" required="required" class="form-control">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input id="nom_marque" name="nom_marque" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted">ex. 99/99/9999</small>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input id="matiere" name="matiere" required="required" class="form-control">
                                    </div>
                                    <small class="form-text text-muted">ex. 99/99/9999</small>
                                </div>
                            </div>
                    ...
                    <div class="col-xs-6 col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                 ...
                                 <select name="reference_sous_categorie" data-placeholder="Choose a Country..." class="standardSelect" tabindex="1">
...
?>
                         ...
                         <div class="card">
                            ...
                            <div class="card-body">
                               ...
                               <select name="etat" data-placeholder="Choose a Country..." class="standardSelect" tabindex="1">
                                                <option value="undefined">non affecte</option>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input id="image_p" name="image_p" type="file" id="file-multiple-input" name="file-multiple-input" multiple="" class="form-control-file"></div>
                                </div>
                            </div>
                        </div>
