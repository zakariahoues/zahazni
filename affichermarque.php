...
$marque=new marqueC();
$listemarques=$marque->affichermarque();
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?PHP echo $row['reference_marque']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['nom_marque']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['image_marque']; ?>
                                            </td>
                                            <td>
                                                <form method="POST" action="supprimermarque.php">
                                                    <input type="submit" name="supprimer" value="supprimer">
                                                    <input type="hidden" value="<?PHP echo $row['reference_marque']; ?>" name="reference_marque">
                                                </form>
                                            </td>
                                            <td><a href="modifiermarque.php?reference_marque=<?PHP echo $row['reference_marque']; ?>">Modifier</a></td>
                                        </tr>
