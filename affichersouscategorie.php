...
$listesouscategories=$sous_categorie->affichersouscategorie();
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">liste Sous Categorie</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Sous Categorie</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?PHP echo $row['reference_sous_categorie']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['nom_sous_categorie']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['image_sous_categorie']; ?>
                                            </td>
                                          

                                            <td>
                                                <form method="POST" action="supprimersouscategorie.php">
                                                    <input type="submit" class="btn btn-danger btn-sm" name="supprimer" value="supprimer">
                                                    <input type="hidden" value="<?PHP echo $row['reference_sous_categorie']; ?>" name="reference_sous_categorie">
                                                </form>
                                            </td>
                                            <td><a  class="btn btn-primary btn-sm" href="modifiersouscategorie.php?reference_sous_categorie=<?PHP echo $row['reference_sous_categorie']; ?>">Modifier</a></td>
                                        </tr>
