                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Nouvelle Sous Categorie</li>
                        </ol>
                    </div>
                </div>
            </div>
        </div>
<form method="POST" action="ajoutsouscategorie1.php">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_sous_categorie" type="number" name="reference_sous_categorie" required="required" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_sous_categorie" type="text" name="nom_sous_categorie" required="required" class="form-control">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="image_sous_categorie" name="image_sous_categorie" multiple="" class="form-control-file"></div>
                            </div>
                        </div>
...
?>
                 ...
                 <button type="RESET" class="btn btn-primary">RESET</button>
                    <button id="send" type="submit" value="ajouter" class="btn btn-success">VALIDER</button>
            </div><!-- .animated -->
        </div><!-- .content -->
</form>
    </div><!-- /#right-panel -->
