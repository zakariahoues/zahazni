...
<form method="POST" action="ajoutrayon1.php">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_r" type="number" name="reference_r" required="required" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_r" type="text" name="nom_r" required="required" class="form-control">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="logo_r" name="logo_r" multiple="" class="form-control-file"></div>
                            </div>
                        </div>
