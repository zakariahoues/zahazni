...
$rayon=new rayonC();
$listerayon=$rayon->afficherrayon();
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Listes Rayon</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Listes Rayon</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?PHP
                                    foreach($listerayon as $row){
                                    ?>
                                   
                                        <tr>
                                            <td>
                                                <?PHP echo $row['reference_r']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['nom_r']; ?>
                                            </td>
                                            <td>
                                            <?php echo '<img src="img/' . $row["logo_r"] . '"width="100" height="30"></img>'; ?>
                                            </td>
                                          

                                            <td>
                                                <form method="POST" action="supprimerrayon.php">
                                                               
                                                    <input type="submit" class="btn btn-danger btn-sm" name="supprimer" value="supprimer">
                                                    <input type="hidden" value="<?PHP echo $row['reference_r']; ?>" name="reference_r">
                                                </form>
                                            </td>
                                            <td> <a class="btn btn-primary btn-sm" href="modifierrayon.php?reference_r=<?PHP echo $row['reference_r']; ?>">Modifier</a></td>
                                        </tr>
