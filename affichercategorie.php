...
$listecategories=$categorie->affichercategorie();
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Listes Categories</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?PHP echo $row['reference_categorie']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['nom_categorie']; ?>
                                            </td>
                                            <td>
<?php echo '<img src="img/' . $row["image_categorie"] . '"width="100" height="30"></img>'; ?>
                                            </td>
                                            ...
                                            <td>
                                                <form method="POST" action="supprimercategorie.php">
                                                    ...
                                                    <input type="hidden" value="<?PHP echo $row['reference_categorie']; ?>" name="reference_categorie">
                                                </form>
                                            </td>
                                            <td><a class="btn btn-primary btn-sm" href="modifiercategorie.php?reference_categorie=<?PHP echo $row['reference_categorie']; ?>">Modifier</a></td>
                                        </tr>
