<?php
  ...
  include_once "C:/xampp/htdocs/zahazni/Entities/marque.php";
  
if (isset($_GET['reference_marque'])){
    $marqueC=new Marquec();
    $result=$marqueC->recuperermarque($_GET['reference_marque']);
    foreach($result as $row){
        $reference_marque=$row['reference_marque'];
        $nom_marque=$row['nom_marque'];
        
        $image_marque=$row['image_marque'];
            ...
            <div class="animated fadeIn">
                <div class="row">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_marque" type="text" name="reference_marque" required="required" class="form-control" value="<?PhP echo $reference_marque ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_marque" type="text" name="nom_marque" required="required" class="form-control" value="<?PhP echo $nom_marque ?>">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input value="<?PhP echo $image_marque ?>" type="file" id="image_marque" name="image_marque" multiple="" class="form-control-file"></div>
                            </div>
                        </div>
                 ...
                 <button type="RESET" class="btn btn-primary">RESET</button>
                    <button  type="submit" value="modifier" class="btn btn-success">VALIDER</button>
                <input type="hidden" name="id_ini" value="<?PHP echo $_GET['reference_marque'];?>">
...
if (isset($_POST['modifier'])){
    $mar=new marque($_POST['reference_marque'],"",$_POST['nom_marque'],0,$_POST['image_marque'],"");
    $marC->modifiermarque($mar,$id_ini);

    echo '<script language="Javascript">
           <!--
                 document.location.replace(" affichermarque.php");
           // -->
     </script>';
}
?>
