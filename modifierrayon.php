...
if (isset($_GET['reference_r'])){
    $rayonC=new rayonC();
    $result=$rayonC->recupererrayon($_GET['reference_r']);
                    ...
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                           ...
                           <li><a href="#">Rayon</a></li>
                            <li class="active">Nouveau Rayon</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_categorie" type="text" name="reference_r" required="required" class="form-control" value="<?PhP echo $reference_r ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_categorie" type="text" name="nom_r" required="required" class="form-control" value="<?PhP echo $nom_r ?>">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="logo_r" name="logo_r" multiple="" class="form-control-file" value="<?PhP echo $logo_r ?>"></div>
                            </div>
                        </div>
...
<input type="hidden" name="reference_ini" value="<?PHP echo $_GET['reference_r'];?>">
...
if (isset($_POST['modifier'])){
    $rayon=new rayon($_POST['reference_r'],$_POST['nom_r'],$_POST['logo_r']);
    $rayonC->modifierrayon($rayon,$_POST['reference_ini']);
