                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Listes produits</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?PHP echo $row['reference_p']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['nom_p']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['quantite_p']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['prix_p']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $row['couleur_p']; ?>
                                            </td>
                                         
                                            <td>
<?php echo '<img src="img/' . $row["image_p"] . '"width="100" height="30"></img>'; ?>
                                            </td>
                                            ...
                                            <td>
                                                <form method="POST" action="supprimerproduit.php">
                                                    ...
                                                    <input type="hidden" value="<?PHP echo $row['reference_p']; ?>" name="reference_p">
                                                </form>
                                            </td>
                                            <td><a class="btn btn-primary btn-sm" href="modifierproduit.php?reference_p=<?PHP echo $row['reference_p']; ?>">Modifier</a></td>
                                        </tr>
