...
if (isset($_GET['reference_sous_categorie'])){
    $sous_categorieC=new sous_categorieC();
    $result=$sous_categorieC->recuperersouscategorie($_GET['reference_sous_categorie']);
    foreach($result as $row){
 $reference_sous_categorie=$row['reference_sous_categorie'];
        $nom_sous_categorie=$row['nom_sous_categorie'];
        $image_sous_categorie=$row['image_sous_categorie'];
...
$resultc = $categoriec->affichercategorie();
?>
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Modifier sous categorie</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_sous_categorie" type="text" name="reference_sous_categorie" required="required" class="form-control" value="<?PhP echo $reference_sous_categorie ?>">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_sous_categorie" type="text" name="nom_sous_categorie" required="required" class="form-control" value="<?PhP echo $nom_sous_categorie ?>">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="image_sous_categorie" name="image_sous_categorie" multiple="" class="form-control-file" value="<?PhP echo $image_sous_categorie ?>"></div>
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <select name="reference_categorie" data-placeholder="Choose a Country..." class="standardSelect" tabindex="1">
                                                <option value="undefined">non affecte</option>
                                                <?php 
foreach($resultc as $row)
{
  ?>
                                                <option value="<?php echo $row['reference_categorie']; ?>"><?php echo $row['nom_categorie']; ?></option>
...
<input type="hidden" name="reference_sous_categorie_ini" value="<?PHP echo $_GET['reference_sous_categorie'];?>">
...
if (isset($_POST['modifier'])){
    $sous_categorie=new sous_categorie($_POST['reference_sous_categorie'],$_POST['nom_sous_categorie'],$_POST['image_sous_categorie'],$_POST['reference_categorie']);
    $sous_categorieC->modifiersouscategorie($sous_categorie,$_POST['reference_sous_categorie_ini']);
    echo $_POST['reference_sous_categorie_ini'];
  //  header('Location: afficherFournisseur.php');
       echo '<script language="Javascript">
           <!--
                 document.location.replace(" affichersouscategorie.php");
           // -->
     </script>';
