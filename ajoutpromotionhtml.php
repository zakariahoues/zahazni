...
$resultc = $produitc->afficherproduit();
            ...
            <div class="animated fadeIn">
                <div class="row">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="dateD" type="date"  value="dateD"   name="dateD" required="required" class="form-control">
                                        </div>
                                 ...
                                 <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="dateF" type="date"  value="dateF"   name="dateF" required="required" class="form-control">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                                 <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="dateD" type="number"  value="pourcentage"   name="pourcentage" required="required" class="form-control">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                                        ...
                                        <div class="card-header">
                                            <strong class="card-title">Id produit</strong>
                                        </div>
                                        <div class="card-body">

                                            <select value="idProduit" name="idProduit" data-placeholder="Choose a Country..." class="standardSelect" tabindex="1">
                                                <option value="undefined">non affecte</option>
                                                <?php 
foreach($resultc as $row)
{
  ?>
                                                <option value="<?php echo $row['reference_p']; ?>"><?php echo $row['nom_p']; ?></option>
