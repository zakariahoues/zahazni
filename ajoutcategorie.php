...
<form method="POST" action="ajoutcategorie1.php">
                            ...
                            <div class="card-body card-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="reference_categorie" type="number" name="reference_categorie" required="required" class="form-control">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-plus-square"></i></div>
                                            <input id="nom_categorie" type="text" name="nom_categorie" required="required" class="form-control">
                                        </div>
                                        <small class="form-text text-muted"> </small>
                                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" id="image_categorie" name="image_categorie" multiple="" class="form-control-file"></div>
                            </div>
                        </div>
